(function () {
  ...
  function isBlogshortcutLink(anchor) {
    ...
    const parentLi = anchor.closest('[data-blogshortcut-trigger]');
    if (parentLi && parentLi.dataset.blogshortcutTrigger === '1') {
      return true;
    }
  ...
  function getModalForm() {
    return document.querySelector('form#new-page') || document.querySelector('form[data-grav-form="new-page"]') || document.querySelector('form#blueprints');
  }
  ...
  function openModal(payload) {
    ...
    const openInstance = function () {
      ...
      const routeField = form ? form.querySelector('select[name="data[route]"]') || form.querySelector('input[name="data[route]"]') : null;
      const nameField = form ? form.querySelector('select[name="data[name]"]') : null;
      ...
      const titleField = form ? form.querySelector('input[name="data[title]"]') : null;
